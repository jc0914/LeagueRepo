namespace ElLeeSin
{
    ...
    internal static class Program
    {
        ...
        {
            if (ObjectManager.Player.IsDashing() || isInQ2 || ObjectManager.Player.IsWindingUp)
            {
                return false;
            }
        ...
        private static void AfterAttack(AttackableUnit unit, AttackableUnit target)
        {
            ...
            if (spells[Spells.E].IsReady() && (target.Type == GameObjectType.obj_AI_Hero) && Misc.IsEOne)
            {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Obj_AI_Base.OnBuffAdd += PassiveManager.OnBuffAdd;
                Obj_AI_Base.OnBuffRemove += PassiveManager.OnBuffRemove;
                Obj_AI_Base.OnProcessSpellCast += Obj_AI_Base_OnProcessSpellCast; 

                Game.PrintChat("<font color='#FF99CC'><b>鑰佺帇瀹氬埗鏈€寮风瀻瀛愪辅 鍔犺級鎴愬姛</b></font><font color='#FF3300'><b>鑰佺帇VIP鑵虫湰浜ゆ祦缇や辅348902882</b></font>");
