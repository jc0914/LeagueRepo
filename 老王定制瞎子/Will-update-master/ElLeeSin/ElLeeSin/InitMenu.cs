    ...
    public class InitMenu
    {
        ...
        public static void Initialize()
        {
            ...
            var insecMenu = Menu.AddSubMenu(new Menu("Insec", "Insec").SetFontStyle(FontStyle.Bold, Color.Aqua));
            {
                ...
                //insecMenu.SubMenu("Insec Modes").AddItem(new MenuItem("InsecMode.Select", "Insec mode:").SetValue(new StringList(new[] { "Allies or Tower", "Original position", "Mouse position" }, 0)));
