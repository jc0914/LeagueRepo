namespace Valvrave_Sharp
{
    ...
    internal class Program
    {
        ...
        {
            MainMenu = new Menu("ValvraveSharp", "老王定制最强亚索", true, Player.ChampionName).Attach();
            MainMenu.Separator("Author: 老王");
            MainMenu.Separator("QQ: 228124423");
            if (isSupport)
            {
        ...
        {
            Game.PrintChat("<font color='#FF99CC'><b>鑰佺帇瀹氬埗浜炵储 娉ㄥ叆鎴愬姛</b></font><font color='#FF3300'><b>鑰佺帇VIP鑵虫湰浜ゆ祦缇や辅348902882</b></font>");
        }
