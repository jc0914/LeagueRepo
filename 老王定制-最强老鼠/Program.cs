namespace Flowers_Twitch
{
    ...
    class Program
    {
        ...
        private static void LoadEvents()
        {
            try
            {
                Game.PrintChat("<font color='#FF99CC'><b>鑰佺帇瀹氬埗鏈€寮疯€侀紶   娉ㄥ叆鎴愬姛</b></font><font color='#FF3300'><b>鑰佺帇VIP鑵虫湰浜ゆ祦缇や辅348902882</b></font>");
        ...
        private static void LoadMenu()
        {
            try
            {
                Menu = new Menu("Twitch", "NightMoon", true).SetFontStyle(FontStyle.Regular, SColor.Red);

                Menu.AddSubMenu(new Menu("Orbwalking", "nightmoon.Orbwalker.Menu"));
                Orbwalker = new Orbwalking.Orbwalker(Menu.SubMenu("nightmoon.Orbwalker.Menu"));

                Menu.AddSubMenu(new Menu("Combo Menu", "nightmoon.Combo.Menu"));
                ...
                Menu.AddSubMenu(new Menu("Harass Menu", "nightmoon.Harass.Menu"));
                ...
                Menu.AddSubMenu(new Menu("Misc Menu", "nightmoon.Misc.Menu"));
                ...
                Menu.AddSubMenu(new Menu("Draw Menu", "nightmoon.Draw.Menu"));
