...
namespace Ezreal
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            SpellList.Add(R1);
            //Create the menu
            Config = new Menu("老王定制 - 伊泽瑞尔", ChampionName, true);
            ...
            Config.SubMenu("R 设置").AddItem(new MenuItem("autoR", "Auto R").SetValue(true));
            ...
            Config.SubMenu("显示设置").AddItem(new MenuItem("rRange", "R 范围").SetValue(false));
            Config.SubMenu("显示设置").AddItem(new MenuItem("onlyRdy", "显示R可击杀目标").SetValue(true));
            Config.SubMenu("显示设置").AddItem(new MenuItem("orb", "走砍 风格").SetValue(true));
            Config.SubMenu("显示设置").AddItem(new MenuItem("semi", "半手动R目标").SetValue(false));
            ...
            Config.AddItem(new MenuItem("noob", " 小白 虐菜模式").SetValue(false));
            Config.AddItem(new MenuItem("Hit", "技能 命中").SetValue(new Slider(3, 4, 0)));
            Config.AddItem(new MenuItem("debug", "调试 模式").SetValue(false));
            Config.AddItem(new MenuItem("laowan", "我爱 老王").SetValue(true));
            Config.AddItem(new MenuItem("laowa", "是否吊打桶神").SetValue(false));

			Config.SubMenu("脚本信息").AddItem(new MenuItem("Sprite", "辉煌游戏工作室"));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("Hanhua", "汉化:辉煌-老王 "));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("wearethebest", "合作伙伴-Seamus"));
            Config.SubMenu("脚本信息").AddItem(new MenuItem("duiwaiqqqun", "对外QQ群:348902882"));

            Game.PrintChat("<font color='#99FFCC'><font size='30'><b>鑰佺帇瀹氬埗-鏈€寮稥Z绯诲垪</b></font><font color='#FF6633'><b>鑰佺帇VIP鑵虫湰浜ゆ祦缇や辅348902882</b></font>");
			Game.PrintChat("<font color='#FF99CC'><b>Seamus甯呴箯楣廣IP瀹氬埗  </b></font><font color='#FF3300'><b>鑰佺帇VIP鑵虫湰浜ゆ祦缇や辅348902882</b></font>");
            Game.PrintChat("<font color='#66FFCC'><b>鍚婃墦鍙扮仯妗剁鎸囧畾涓撶敤鑵虫湰</b></font>!");
