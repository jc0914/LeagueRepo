...
namespace Jinx.Modes
{
    ...
    internal class ModeDraw
    {
        ...
        public void Init()
        {
            MenuLocal = new Menu("显示", "Drawings");
            {
                ...
                SubMenuManaBarIndicator = new Menu("法力值显示", "ManaBarIndicator");
                {
                    for (int i = 0; i < 2; i++)
                    {
                ...
                SubMenuSpells = new Menu("技能范围", "DrawSpellRanges");
                {
                    for (int i = 0; i < 2; i++)
                    {
                ...
                SubMenuBuffs = new Menu("别动", "DrawBuffTimes");
                {
                    for (int i = 0; i < 2; i++)
                    {
                ...
                SubMenuAxe = new Menu("别搞事", "DrawAxeTimers");
                {
                    for (int i = 0; i < 2; i++)
                    {
