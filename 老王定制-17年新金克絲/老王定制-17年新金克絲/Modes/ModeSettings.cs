...
namespace Jinx.Modes
{
    ...
    internal class ModeSettings
    {
        ...
        {
            MenuLocal = new Menu("技能预判设置", "Settings");
            MenuParent.AddSubMenu(MenuLocal);

            MenuSpellW = new Menu("W预判设置", "SettingsW").SetFontStyle(FontStyle.Regular, Champion.PlayerSpells.Q.MenuColor());
            {
            ...
            MenuSpellR = new Menu("R预判设置", "SettingsR").SetFontStyle(FontStyle.Regular, Champion.PlayerSpells.Q.MenuColor());
            {
