       ...
       public static void Main(string[] args)
        {
            try
            {
				...
				Game.PrintChat("<font color='#003399'><b>鏈€鏂版渶寮烘杩庡姞鍏ワ紒</b></font><font color='#FFFF00'><b>Z瀛楀彿鑴氭湰瀹氬埗缇わ細264791942</b></font><font color='#FF9900'><b>-</b></font>");
            }
            catch (Exception e)
            {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu = new Menu("Z字号定制VN", "Z字号定制VN", true);
            //Orbwalker
            menu.AddSubMenu(new Menu("Orbwalker", "Orbwalker"));
            orbwalker = new Orbwalking.Orbwalker(menu.SubMenu("Orbwalker"));
            menu.AddItem(
                new MenuItem("aaqaa", "平A -> Q -> 平A").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            ...
            menu.AddItem(new MenuItem("useR", "用R连招").SetValue(true));
            menu.AddItem(new MenuItem("enemys", "如果周围敌人 >=").SetValue(new Slider(2, 1, 5)));
            ...
            menu.AddItem(new MenuItem("Z字号", "Z字号定制脚本QQ群：264791942"));
            menu.AddItem(new MenuItem("Z字号2", "每个脚本都是精品！"));
